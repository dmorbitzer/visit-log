...
return [
    ...
    'description' => 'REST API for VisitLog — a digital visitor tracking system for events and venues.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token via <code>POST /api/tokens/create</code> with your username and password.',
    ],
